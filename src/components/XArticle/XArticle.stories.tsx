...
export const Default: Story = {
    render: () => (
        <XArticle className={'theme background padding'}>
            ...
            <p>Regular paragraph text that follows a heading. The spacing between elements follows a consistent vertical
                rhythm based on the line height.</p>
            <p>A second paragraph to show the spacing between consecutive paragraphs.</p>

            <h3>Subsection</h3>
            <p>Content under a smaller heading. Here's some <code>inline code</code> as well. Now let's continue with the following subjects:</p>
